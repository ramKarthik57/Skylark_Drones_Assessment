...
import { Activity, Database, FileText, RefreshCw, LayoutDashboard, MessageSquare, ShieldAlert, ShieldCheck } from 'lucide-react';
import type { BoardStatus } from '../types';

interface HeaderProps {
  status: BoardStatus | null;
  activeTab: 'command_center' | 'ask_ai' | 'risk_radar' | 'data_trust';
  onTabChange: (tab: 'command_center' | 'ask_ai' | 'risk_radar' | 'data_trust') => void;
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center flex-wrap gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-medium text-xs shadow-md shadow-cyan-500/20 transition-all transform hover:-translate-y-0.5"
          >
